...
public class BaHealerOrderFoodOverlay extends OverlayPanel implements MouseListener
{
    ...
    public Dimension render(Graphics2D graphics)
    {
        ...
        BaHealerOrderConfig.FoodPanelStyle panelStyle = plugin.getFoodPanelStyle();

        if (panelStyle == BaHealerOrderConfig.FoodPanelStyle.CODE_ONLY)
        {
