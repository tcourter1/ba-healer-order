...
* **1.0.8** - Added healer-only poisoned food menu protection. Added option to show healer codes in the right-click menu on tagged healers. Added dispenser menu options.
